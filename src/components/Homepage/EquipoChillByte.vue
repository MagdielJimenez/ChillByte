        ...
        <b-col sm="12" md="6" class="d-flex justify-content-center">
          <div v-if="secondIsVisible" class="bounce-in-down-enter-active">
            <b-card title="Magdiel Jiménez Tabla"
              img-src="https://firebasestorage.googleapis.com/v0/b/bloona-55051.appspot.com/o/Foto%20Mag%20Chillbyte2.png?alt=media&token=ebaf6791-89db-4e3a-addd-ad05f94e4361"
